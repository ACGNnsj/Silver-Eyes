...
/** @type {string} */
const OFFLINE_URL = 'Silver Eyes.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Silver Eyes.html","Silver Eyes.js","Silver Eyes.offline.html","Silver Eyes.icon.png","Silver Eyes.apple-touch-icon.png","Silver Eyes.audio.worklet.js","Silver Eyes.audio.position.worklet.js"];
